       ...
       versions.forEach(function(version) {
         ...
         if (scenario && semver.gte(version, '1.13.0')) {
           ...
           packageJson.then(function(scenario, json) {
             scenario.npm.devDependencies = object.merge({}, json.devDependencies, scenario.npm.devDependencies);
           }.bind(undefined, scenario));

           bowerJson.then(function(scenario, json) {
             scenario.bower.dependencies = object.merge({}, json.dependencies, scenario.bower.dependencies);
           }.bind(undefined, scenario));
