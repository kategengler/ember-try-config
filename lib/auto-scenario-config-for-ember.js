...
module.exports = function generateConfig(semverStatements, availableVersions) {
  return { scenarios:  [].concat(baseScenarios(), generateScenariosFromSemver(semverStatements, availableVersions))};
};
